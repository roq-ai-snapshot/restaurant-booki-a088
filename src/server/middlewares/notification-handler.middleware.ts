...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'OrderCreated.create': {
    roles: ['owner', 'chef', 'waiter', 'wait-staff'],
    key: 'orderId',
    tenantPath: [],
    userPath: [],
  },
  ...
  'FeedbackCreated.create': { roles: ['owner'], key: 'feedbackId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['owner', 'chef', 'waiter', 'wait-staff'];
